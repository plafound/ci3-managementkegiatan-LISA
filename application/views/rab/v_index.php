<div class="pageheader ">
	<h3><i class="fa fa-home"></i> RAB - <?= $proposal['0']->judul?></h3>
	<div class="breadcrumb-wrapper">
		<span class="label">You are here:</span>
		<ol class="breadcrumb">
			<li> <a href="<?=site_url('home')?>"> Home </a></li>
			<li> <a href="<?=site_url('c_kegiatan/detail/'. $kegiatan['id'])?>">Kegiatan </a> </li>
			<li class="active"> <a href="<?=site_url('c_proposal/lihat/'.$kegiatan['ids'])?>">Proposal </a></li>
			<li class="active"> <a > RAB </a> </li>
		</ol>
	</div>
</div>
<!-- Basic Data Tables -->
							...
							<tr>
								...
								<td width="350">
									<a href="#" class=" btn btn-small btn-edit" data-toggle="modal"
										data-target="#modalUbah" data-id="<?=$rab->id?>"
										data-proposal_id="<?=$rab->proposal_id?>"
										data-keterangan="<?=$rab->keterangan?>" data-jumlah="<?=$rab->jumlah?>"
										data-satuan="<?=$rab->satuan?>" data-total="<?=$rab->total?>">
										<i class=" fa fa-pencil"></i>
										Edit</a>
									<a href="<?php echo site_url('c_rab/hapus/'. $rab->id .  "/" . $rab->proposal_id)?>"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo site_url('c_rab/tambah')?>" method="POST" enctype="multipart/form-data">
					<input type="hidden" name="proposal_id" value="<?=$proposal[0]->id?>">
...
<div class="modal modal-default fade" id="modalUbah">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo site_url('c_rab/ubah')?>" method="POST" enctype="multipart/form-data">
