<div class="pageheader ">
	...
	<div class="breadcrumb-wrapper">
		...
		<li> <a href="<?=site_url('home')?>"> Home </a></li>
			...
			<li> <a href="<?=site_url('c_proposal/lihat/'. $kegiatan['id'])?>">Proposal </a> </li>
			<li class="active"> <a> Tambah Proposal </a> </li>
		</ol>
	</div>
</div>
<!--Page content-->
	...
	<div class="col-md-12">
		...
		<div class="panel">
			<div class="panel-heading">
				<h3 class="panel-title"><a href="<?php echo site_url('c_proposal/lihat/'. $kegiatan['id'])?>">
