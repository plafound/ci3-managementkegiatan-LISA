...
<link rel="icon" href="<?= base_url('assets/assetslogin/img');?>/logo-lisa.png" type="image/png">
<!--STYLESHEET-->
<!--=================================================-->
...
<link href="<?php echo base_url('assets/admin/plugins/bootstrap-datepicker/bootstrap-datepicker.css')?>" rel="stylesheet">
...
<!--Demo [ DEMONSTRATION ]-->
<link href="<?php echo base_url('assets/admin/css/demo/gamma-gallery.css')?>" rel="stylesheet">
<!--SCRIPT-->
<!--=================================================-->
<script src="<?php echo base_url('assets/admin/plugins/gamma-gallery/js/modernizr.custom.70736.js')?>"></script>
