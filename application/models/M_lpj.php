...
class M_lpj extends CI_Model
{
	...
	public function getByLaporan($id)
    {
        return $this->db->get_where($this->_table, ["laporan_id" => $id])->result();
    }
	public function getByLaporanWithSum($laporan_id)
    {
    ...
    {
        $post = $this->input->post();
        $this->db->set('laporan_id', $post["laporan_id"]);
